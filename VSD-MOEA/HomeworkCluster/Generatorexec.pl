...
"DTLZ7 22 3");
	foreach my $line (@Conf)
	{
		for(my $Seed = 1; $Seed <=35; $Seed++) ##Realizar 35 ejecuciones con distintas semilla de cada instancia..
		{
			...
			print $fout "~$PathAlgorithm/Ejecutable --n 100 --nfes 25000000 --nvar $nvar --Instance $inst --Path $PathAlgorithm --Dist_factor 0.4 --nobj $nobj --Seed $Seed --param_l 20 --param_k 4 \n";
		}
	}
